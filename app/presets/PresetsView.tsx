...
const COLLECTIONS = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#5eb8b0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#c9cdd1" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex flex-col gap-7">
          <div>
            <h1 className="text-3xl font-extrabold leading-tight lg:text-[42px]">
              49 Lightroom presets, built from real London nights
            </h1>
            <p className="mt-3.5 max-w-xl text-[15px] leading-relaxed text-[#c9cdd1] lg:text-[17px]">
              The exact edits behind every @lamberts.lens post, grouped into
              9 cinematic collections. One preset pack, one download, ready
              in Lightroom in seconds.
            </p>
          </div>

          {/* TODO: swap in a real before/after pair once you have one exported from the actual presets */}
          <BeforeAfterCard beforeSrc="/IMG_5191.jpg" afterSrc="/IMG_5191.jpg" />
      ...
      <div className="px-6 pb-16 lg:px-16">
        <div className="mb-7">
          <h3 className="text-2xl font-extrabold">
            Nine collections. One purchase.
          </h3>
          <p className="mt-2 text-sm text-[#8a8f94]">
            Every pack is grounded in real edits from real photos — not
            guesses at a look.
          </p>
        </div>
