...
export const BackgroundCircles = ({ backgroundColor }: Props) => {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#f7ab0a]  rounded-full h-[618px] w-[618px] sm:h-[650px] sm:w-[650px] mt-52 animate-pulse opacity-20" />
      <div className="absolute border border-[#333333]  rounded-full h-[760px] w-[760px] sm:h-[800px] sm:w-[800px] mt-52 " />
    </motion.div>
  );
};
