...
export default function WorkExperience({ experiences }: Props) {
  return (
    <div className="relative flex flex-col items-center justify-evenly h-screen max-w-full px-1 md:px-10 mx-auto overflow-hidden text-left md:flex-row">
      ...
      <div className="scrollbar-thin w-full mt-20 md:mt-0 flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#f7ab0a]/80">
